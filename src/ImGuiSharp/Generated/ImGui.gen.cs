...
namespace ImGuiSharp
{
    public static unsafe partial class ImGui
    {
        ...
        {
            var ret = ImGuiNative.igGetKeyIndex(key);
            return ret;
        }
        public static string GetKeyName(ImGuiKey key)
        {
            var ret = ImGuiNative.igGetKeyName(key);
            return Util.StringFromPtr(ret);
        }
        public static int GetKeyPressedAmount(ImGuiKey key, float repeat_delay, float rate)
        {
            var ret = ImGuiNative.igGetKeyPressedAmount(key, repeat_delay, rate);
            return ret;
        }
        ...
        {
            var ret = ImGuiNative.igGetMouseClickedCount(button);
            return ret;
        }
